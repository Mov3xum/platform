  ...
  return (
    <div className="mx-view-pad mx-narrow">
      <PageHead
        ...
        subtitle="Test-läge för Movexum-personal. Konversationen lagras i tenant-isolerad logg och dyker upp som lead (markerad Förhandsgranskning — räknas inte i statistiken) redan vid första svaret."
        actions={
