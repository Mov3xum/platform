...
import { X, CheckCircle2, Lock, Settings2, Zap } from 'lucide-react';
...
export function IntegrationActivateButton({ integrationName, providerIcon, accentClass }: Props) {
                ...
                <div className={`relative overflow-hidden rounded-t-3xl ${accentClass} px-6 pb-5 pt-6`}>
                  ...
                  <Dialog.Close asChild>
                    <button
                      type="button"
                      aria-label="Stäng"
                      className="absolute right-4 top-4 inline-flex h-8 w-8 items-center justify-center rounded-xl border border-default bg-surface/80 text-foreground-muted transition hover:bg-canvas-subtle hover:text-foreground"
                    >
                      <X className="h-4 w-4" />
                    </button>
                  </Dialog.Close>
                ...
                <div className="px-6 py-5">
                      ...
                      return (
                        <li key={step.title} className="flex gap-4">
                          <div className="flex flex-col items-center">
                            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-default bg-canvas-subtle text-brand">
                  ...
                  <div className="mt-2 rounded-2xl border border-movexum-gul/40 bg-movexum-pastell-gul px-4 py-3 dark:border-movexum-morkgul/50 dark:bg-movexum-morkgul/20">
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-movexum-morkgul dark:text-movexum-gul" />
