/**
 * Delad retry-med-backoff-logik för PocketBase superuser-auth.
 *
...
/**
 * Autentiserar som PocketBase superuser med retry-med-backoff på transienta
 * fel (429/5xx/nätverk). Kastar ALDRIG — returnerar `null` vid lyckad auth,
